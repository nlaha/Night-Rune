...
public class GlobalData
{
    ...
    public async Task InitializeAsync()
    {
        ...
        if (!File.Exists(ConfigPath))
        {
            ...
            Log.Information("Bot", LogSeverity.Error, "No Config file found. A new one has been generated. Please close the & fill in the required section.");
            await Task.Delay(-1);
        }
